    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a href="http://demo.opencart.com/admin/index.php?route=catalog/category" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Cancel"><i class="fa fa-reply"></i></a></div>
            <h1>Categories</h1>
            <ul class="breadcrumb">
                <li><a href="http://demo.opencart.com/admin/index.php?route=common/dashboard">Home</a></li>
                <li><a href="http://demo.opencart.com/admin/index.php?route=catalog/category">Categories</a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="http://demo.opencart.com/admin/index.php?route=catalog/category/edit&amp;category_id=33" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="language1">
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="category_description[1][name]" value="Cameras" placeholder="Category Name" id="input-name1" class="form-control">
                                        </div>
                                    </div>
