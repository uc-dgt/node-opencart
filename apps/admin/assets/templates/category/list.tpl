                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-right"><a href="#catalog/category/edit/1" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right"><a href="#catalog/category/edit/25" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right"><a href="#catalog/category/edit/29" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">1</td>
                                    <td class="text-right"><a href="#catalog/category/edit/28" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right"><a href="#catalog/category/edit/35" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">0</td>
                                    <td class="text-right"><a href="#catalog/category/edit/36" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">1</td>
                                    <td class="text-right"><a href="#catalog/category/edit/30" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">1</td>
                                    <td class="text-right"><a href="#catalog/category/edit/31" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">1</td>
                                    <td class="text-right"><a href="#catalog/category/edit/32" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">1</td>
                                    <td class="text-right"><a href="#catalog/category/edit/20" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right"><a href="#catalog/category/edit/27" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">1</td>
                                    <td class="text-right"><a href="#catalog/category/edit/26" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">2</td>
                                    <td class="text-right"><a href="#catalog/category/edit/18" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">0</td>
                                    <td class="text-right"><a href="#catalog/category/edit/46" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">0</td>
                                    <td class="text-right"><a href="#catalog/category/edit/45" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right"><a href="#catalog/category/edit/34" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">0</td>
                                    <td class="text-right"><a href="#catalog/category/edit/43" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">0</td>
                                    <td class="text-right"><a href="#catalog/category/edit/44" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">0</td>
                                    <td class="text-right"><a href="#catalog/category/edit/47" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">0</td>
                                    <td class="text-right"><a href="#catalog/category/edit/48" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
